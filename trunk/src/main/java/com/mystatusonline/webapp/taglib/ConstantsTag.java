package com.mystatusonline.webapp.taglib;
 ...
 *
 * <p> <a href="BaseAction.java.html"><i>View Source</i></a> </p>
 *
...
public class ConstantsTag
   ...
   * value.
   *
   * @param scopeName Can be "page", "request", "session", or "application" in
   * any case.
