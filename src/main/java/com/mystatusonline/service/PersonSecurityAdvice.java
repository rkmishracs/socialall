 ...
 * @author mraible
 */
public class PersonSecurityAdvice
  implements MethodBeforeAdvice, AfterReturningAdvice {
    ...
    private final Log log = LogFactory.getLog(PersonSecurityAdvice.class);
    ...
    public void before(Method method, Object[] args, Object target) throws Throwable {
        ...
        if (ctx.getAuthentication() != null) {
            ...
            if (!signupUser) {
                Person currentUser = getCurrentUser(auth);
    ...
    private Person getCurrentUser(Authentication auth) {
        Person currentUser;
        if (auth.getPrincipal() instanceof UserDetails) {
            currentUser = (Person) auth.getPrincipal();
        } else if (auth.getDetails() instanceof UserDetails) {
            currentUser = (Person) auth.getDetails();
        } else {
